...
public class InstrumentationExample {
    ...
    public static void main(String[] arguments) {
        ...
        printObjectSize(new User("Evgeny", 43));
        User ivan = new User("Ivan", 33);
        System.out.print("Размер объекта User ");
        printObjectSize(ivan);
        System.out.print("Размер поля name ");
        printObjectSize(ivan.name);
        System.out.print("Размер поля age ");
        printObjectSize(ivan.age);
    }
